#!/bin/sh
# Install Codex Orchestration 0.8.8 and safely retire obsolete identities.
...
printf '%s\n' "$manifest_version" | grep -Eq '^0\.8\.8$' ||
  fail "this installer requires the traditional release version 0.8.8: $manifest_version"
