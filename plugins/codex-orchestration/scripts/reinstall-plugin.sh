#!/bin/sh
# Install Codex Orchestration 0.12.3 and safely retire obsolete identities.
...
printf '%s\n' "$manifest_version" | grep -Eq '^0\.12\.3$' ||
  fail "this installer requires the traditional release version 0.12.3: $manifest_version"
