#!/bin/sh
# Install Codex Orchestration 0.10.1 and safely retire obsolete identities.
...
printf '%s\n' "$manifest_version" | grep -Eq '^0\.10\.1$' ||
  fail "this installer requires the traditional release version 0.10.1: $manifest_version"
