#!/bin/sh
# Install Codex Orchestration 0.10.4 and safely retire obsolete identities.
...
printf '%s\n' "$manifest_version" | grep -Eq '^0\.10\.4$' ||
  fail "this installer requires the traditional release version 0.10.4: $manifest_version"
