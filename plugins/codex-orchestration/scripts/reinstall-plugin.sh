#!/bin/sh
# Install Codex Orchestration 0.9.0 and safely retire obsolete identities.
...
printf '%s\n' "$manifest_version" | grep -Eq '^0\.9\.0$' ||
  fail "this installer requires the traditional release version 0.9.0: $manifest_version"
