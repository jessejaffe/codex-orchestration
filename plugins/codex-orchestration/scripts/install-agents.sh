#!/bin/sh
# Install the eleven Codex Orchestration 0.8.2 roles and retain stable old-task identities.
...
retired_roles='terra-medium-implementer
sol-low-implementer
...
previous_digest() {
  case "$1" in
    terra-grader) printf '%s\n' 7f7d361950ed434f309e9915f0cf1a606aa00728d4bc0d3c99cc8ae4f7669f3f ;;
    terra-read-only) printf '%s\n' 9bda4860b024839aa91a744ebb3c82116a7fa1009209bed67057c2c3c3461d19 ;;
    ...
    terra-implementer) printf '%s\n' c36e4ccf25a51f911ad8fac00e235f2d23f623184dc71c08cdddebc8f7d71342 1fe32ab9230c3827f7abc489a5062d6cce2847f15341cbad1cac4e062ef5ece3 a24c4a1a67b4730f24d9d883cbbc6fb46b535847ddafa1599ff2127f5ca8b974 ;;
    sol-high-implementer) printf '%s\n' 98c135e10d0b66fa911eab99c1229b530e27d7ac0e5dc983dcef181806e67e6f ac4fb9c02a6d4d53d767fa2667dff3b7e6a41ce8b5032f1f179ee5607cd73c94 b9c8acb6206331972722cba1943c5a86aaaccdbaa85714188e8cfcce2f0a9ec0 ;;
    terra-supervisor) printf '%s\n' 47ca1d10eba36a709f782f52d1c867d9b50094075ea620fae549d1a308f4fe9f ;;
    sol-high-supervisor) printf '%s\n' 8f25a162a0c979163c262ff7cd24542dc64b7daef882fd288b1c29a53a1902bd ;;
    ...
    sol-high-executive) printf '%s\n' 3c6e87c47d980fd8e7a3eaad17130346bc658f1e6083637dae3a7db73db01ae9 d0b5a76a6857097e2838504bbb11346b2bc3a109aedf5d9ef395b5497f726914 c42d421890509b4e68ee2e664f588308341d749520f65ef964570f9a8cc412cd c1a8aa093923c2d2ddaf09adbac7ad801273f8c92141bff2f12994d56235e134 6d31cc7972d426dd21ea5729a7e7c96764b5ff2fad4d34f0667ea2cbebdc89e9 ;;
    sol-xhigh-executive) printf '%s\n' a697493f6144e3619f1334f1c49673f91cd5b3e2c3173efcfb149248fa2545ec 9ec152a58a5b7943985614f57710ac2560ffec65f8e89ba05346377dcdc96df7 35840c3b0dfaa0d25a67bc7de556200e8bf45069853417c9fce91debd1941091 99e1356e1e50185714c1da7d797e01cf0b3ff973ec120319aa1cc0af66957f72 ;;
    *) printf '%s\n' '' ;;
  esac
}
...
if [ "$check_only" -eq 1 ]; then
  ...
  printf '%s\n' 'CHECK PASSED: eleven 0.8.2 roles are current and obsolete roles are absent.'
  exit 0
fi
...
printf '%s\n' 'INSTALL PASSED: eleven 0.8.2 roles are current and stable old-task identities were retained.'
