...
role_files() {
  ...
  case "$role" in
    ...
    sol-xhigh-executive)
      ...
      previous_current_digests='d32694987e8c22fea5efc2936498fb56ee160d84f4650e927e7c3ebdccc18540 1994415d11c7db839d3ac337bf537b9fac145bb6db39f3f23f2705ad5bef597f'
      legacy_digests=''
      ;;
    sol-reviewer)
