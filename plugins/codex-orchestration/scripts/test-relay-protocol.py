...
def main() -> int:
    ...
    require(
        router,
        (
            "CODEX_ORCHESTRATION_ROOT_CONTRACT", "0.9.0-named-launch-v4",
            ...
            "DIRECT NAMED LAUNCH", "collaboration `spawn_agent`",
            ...
            "visible model lane at creation time", "Never wrap launch in `exec`",
            "create a host-nicknamed child", "call `set_thread_title`", "`ALL_TOOLS`", *HUMAN_ROUTES,
    ...
    forbid(
        ...
        (
            ...
            "tools.multi_agent_v1__spawn_agent", "tools.codex_app__set_thread_title",
            "fork_context: false",
        ),
        "root coordinator",
    )
