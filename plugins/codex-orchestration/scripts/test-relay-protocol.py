...
def main() -> int:
    ...
    require(
        router,
        (
            "CODEX_ORCHESTRATION_ROOT_CONTRACT", "0.9.0-direct-launch-v2",
            ...
            "Keep startup quiet", "DIRECT DESKTOP LAUNCH",
            ...
            "host-generated temporary label", "Do not first inspect", *HUMAN_ROUTES,
            ...
            "complete private concise whole-chat context", "requests, assistant facts",
            "newest outcomes", "TURN values do not",
