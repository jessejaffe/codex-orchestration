...
def main() -> int:
    ...
    require(
        ...
        (
            ...
            "NATIVE COLLABORATION LAUNCH", "very next action must be a top-level call",
            ...
            "rename the child afterward", *HUMAN_ROUTES,
    ...
    forbid(
        ...
        (
            ...
            "message=packet", "After creating `packet`", "const packet",
            "fork_context: false",
        ),
        "root coordinator",
    )
