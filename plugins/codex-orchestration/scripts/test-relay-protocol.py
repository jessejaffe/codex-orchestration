...
def main() -> int:
    ...
    require(
        router,
        (
            "CODEX_ORCHESTRATION_ROOT_CONTRACT", "0.9.0-direct-launch-v3",
            ...
            "task is the only startup progress indicator", "## Classification",
            ...
            "tools.multi_agent_v1__spawn_agent", "fork_context: false",
            "tools.codex_app__set_thread_title", "threadId: launch.agent_id",
            "text(JSON.stringify({agent_id: launch.agent_id}))",
            "GPT-5.6 Luna / Max", "GPT-5.6 Terra / Max", "GPT-5.6 Sol / High",
            "immediate title call replaces it with model identity", "Do not first inspect", *HUMAN_ROUTES,
