    ...
    for filename in (
        ...
        require(
            ...
            (
                ...
                "Apply the following voice only to the completed report shown to the user",
                "keep your implementation,", "verification, and any agent-to-agent communication",
                "slightly less technical language", "Lead with the outcome",
                "briefly explain unavoidable jargon", "Preserve exact commands, paths, identifiers",
